 ...
 * @author adam
 */
public class f13 implements FitnessFunction {
    ...
    public double getValue(double[] features) {
        ...
        try {
            tf.test_func(features,f,features.length,1,13);
        } catch (Exception ex) {
            Logger.getLogger(f13.class.getName()).log(Level.SEVERE, null, ex);
        }
        return f[0];
