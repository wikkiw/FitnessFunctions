 ...
 * @author adam
 */
public class f14 implements FitnessFunction {
    ...
    public double getValue(double[] features) {
        ...
        try {
            tf.test_func(features,f,features.length,1,14);
        } catch (Exception ex) {
            Logger.getLogger(f14.class.getName()).log(Level.SEVERE, null, ex);
        }
        return f[0];
