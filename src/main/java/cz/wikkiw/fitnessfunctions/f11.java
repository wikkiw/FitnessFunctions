 ...
 * @author adam
 */
public class f11 implements FitnessFunction {
    ...
    public double getValue(double[] features) {
        ...
        try {
            tf.test_func(features,f,features.length,1,11);
        } catch (Exception ex) {
            Logger.getLogger(f11.class.getName()).log(Level.SEVERE, null, ex);
        }
        return f[0];
