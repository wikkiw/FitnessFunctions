 ...
 * @author adam
 */
public class f12 implements FitnessFunction {
    ...
    public double getValue(double[] features) {
        ...
        try {
            tf.test_func(features,f,features.length,1,12);
        } catch (Exception ex) {
            Logger.getLogger(f12.class.getName()).log(Level.SEVERE, null, ex);
        }
        return f[0];
